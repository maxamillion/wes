...
from ..utils.exceptions import GeminiIntegrationError, RateLimitError, AuthenticationError
...
class GeminiClient:
    ...
    def __init__(self, api_key: str, model_name: str = "gemini-pro", 
                 rate_limit: int = 60, timeout: int = 60):
    ...
    def _sanitize_activity_data(self, activity_data: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    def _prepare_prompt(self, activity_data: List[Dict[str, Any]], custom_prompt: Optional[str] = None) -> str:
    ...
    async def generate_insights(self, activity_data: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    async def generate_action_items(self, activity_data: List[Dict[str, Any]]) -> Dict[str, Any]:
...
class SummaryFormatter:
    ...
    def format_for_document(summary: Dict[str, Any]) -> str:
        ...
        # Add footer
        formatted += f"\n\n---\n"
        formatted += f"*Generated by Executive Summary Tool using {summary.get('model', 'AI')}*\n"
