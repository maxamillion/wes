...
class JiraClient:
    ...
    async def _process_issue(self, issue: Any, include_comments: bool) -> Dict[str, Any]:
        ...
        try:
            activity = {
                ...
                'description': InputValidator.sanitize_text(issue.fields.description or ''),
        ...
        try:
            ...
            for project in projects:
                project_data = {
                    ...
                    'description': InputValidator.sanitize_text(project.description or ''),
    ...
    async def get_users(self, project_key: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    def get_connection_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'server_info': self._jira_client.server_info() if self._jira_client else None
        }
