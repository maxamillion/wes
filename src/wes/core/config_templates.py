...
class JiraConfigTemplate(ConfigTemplate):
    ...
    def __init__(self):
        super().__init__(
            "Jira Configuration",
            "Standard Jira setup for team activity tracking"
        )
    ...
    def generate_config(self, user_inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        config = {
            ...
            "default_query": default_queries.get(use_case, default_queries["executive_summary"]),
    ...
    def get_required_inputs(self) -> List[Dict[str, str]]:
        ...
        return [
            ...
            },
            {
                ...
                "type": "select", 
                "options": ["executive_summary", "weekly_review", "sprint_summary", "team_performance"],
...
class GoogleConfigTemplate(ConfigTemplate):
    ...
    def generate_config(self, user_inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        config = {
            ...
            "timeout": 60,
            "default_folder_structure": folder_structures.get(storage_preference, "Executive Summaries"),
...
class AIConfigTemplate(ConfigTemplate):
    ...
    def __init__(self):
        super().__init__(
            "AI Configuration",
            "Google Gemini setup for intelligent summary generation"
        )
    ...
    def generate_config(self, user_inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        config = {
            ...
            "custom_prompt": audience_prompts.get(audience, audience_prompts["executives"]),
...
class SecurityConfigTemplate(ConfigTemplate):
    ...
    def generate_config(self, user_inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        config = compliance_settings.get(compliance_level, compliance_settings["standard"])
        
        # Adjust based on data sensitivity
        if data_sensitivity == "high":
            config["key_rotation_days"] = min(config["key_rotation_days"], 60)
            config["session_timeout_minutes"] = min(config["session_timeout_minutes"], 45)
...
class TemplateManager:
    ...
    def generate_full_config(self, user_inputs: Dict[str, Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def suggest_defaults_for_organization(self, org_info: Dict[str, Any]) -> Dict[str, Any]:
