...
class WelcomePage(WizardPage):
    ...
    def __init__(self):
        ...
        time_label.setStyleSheet("background-color: #e8f4fd; padding: 10px; border-radius: 4px;")
...
class ServiceSelectionPage(WizardPage):
    ...
    def __init__(self):
        ...
        services = [
            ...
            ("google_drive", "Google Drive", "For creating and storing documents", False),
...
class JiraSetupPage(WizardPage):
    ...
    def _set_cloud_username_guidance(self):
        ...
        self.username_edit.setPlaceholderText("your.email@company.com")
        self.username_edit.setToolTip("Jira Cloud requires your email address as the username")
...
class SummaryPage(WizardPage):
    ...
    def update_status(self, configured_services: Dict[str, bool], service_data: Dict[str, Dict]):
    ...
    def finish_setup(self):
        ...
        try:
            ...
            if service_selection.get("jira", False):
                ...
                self.config_manager.store_credential("jira", "api_token", jira_data["api_token"])
            ...
            if service_selection.get("google_drive", False):
                ...
                if "client_secret" in google_data:
                    self.config_manager.store_credential("google", "oauth_client_secret", google_data["client_secret"])
                if "refresh_token" in google_data:
                    self.config_manager.store_credential("google", "oauth_refresh_token", google_data["refresh_token"])
            ...
            if service_selection.get("gemini", False):
                ...
                self.config_manager.store_credential("ai", "gemini_api_key", gemini_data["api_key"])
