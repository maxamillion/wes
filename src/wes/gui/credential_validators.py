...
class CredentialHealthMonitor:
    ...
    def check_credential_health(self, service: Any, timeout: int = 30) -> HealthCheckResult:
    ...
    def check_expiration(self, expiry_date: datetime, warning_days: int = 7) -> ExpirationResult:
    ...
    def rotate_credential(self, old_credential: str, new_credential: str) -> RotationResult:
