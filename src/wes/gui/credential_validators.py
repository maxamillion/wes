...
class CredentialValidator:
    ...
    def validate_jira_credentials(self, url: str, username: str, api_token: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            if not self._validate_username(url, username):
                if self._is_atlassian_cloud(url):
                    return False, "Username must be a valid email address for Jira Cloud"
                else:
    ...
    def validate_google_credentials(self, cred_data: Dict[str, str]) -> Tuple[bool, str]:
    ...
    def validate_gemini_credentials(self, api_key: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            self.security_logger.log_security_event(
                "gemini_credential_validation_failed",
                severity="WARNING",
                error=str(e)
            )
            return False, error_msg
    ...
    def _parse_gemini_error(self, error: Exception) -> str:
        ...
        if 'api key' in error_str:
            ...
            return "Permission denied. Please ensure the API key has proper permissions."
...
class ServiceDiscovery:
    ...
    def suggest_oauth_scopes(self, service: str, use_case: str = "executive_summary") -> List[str]:
...
class CredentialHealthMonitor:
    ...
    def check_credential_health(self, service: str, credentials: Dict[str, str]) -> Dict[str, any]:
        ...
        try:
            ...
            if not success:
                ...
                health_status["recommendations"].append("Please re-configure credentials")
    ...
    def _check_google_token_expiration(self, credentials: Dict[str, str], health_status: Dict):
    ...
    def get_health_recommendations(self, health_results: List[Dict[str, any]]) -> List[str]:
